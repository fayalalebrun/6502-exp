...
IO_AREA	= $4000		; set I/O area for this monitor

ACIAsimwr	= IO_AREA+$00	; simulated ACIA write port
ACIAsimrd	= IO_AREA+$00	; simulated ACIA read port
ACIAsimstatus   = IO_AREA+$01
